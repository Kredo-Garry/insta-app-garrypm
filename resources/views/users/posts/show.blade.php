        ...
        <div class="col-4 px-0 bg-white">
            <div class="card border-0">
                ...
                <div class="card-body w-100">
                    ...
                    <p class="text-danger small">Posted {{ $post->created_at->diffForHumans()}}</p>
                    ...
                    <div class="mt-4">
                        <form action="{{ route('comment.store', $post->id) }}" method="post">
                            ...
                            <div class="input-group">
                                <textarea name="comment_body{{ $post->id }}" rows="1" class="form-control form-control-sm" placeholder="Add your comment...">{{ old('comment_body' . $post->id) }}</textarea>
                                ...
                                @foreach ($post->comments as $comment)
                                    <li class="list-group-item border-0 p-0 mb-2">
                                        ...
                                        <form action="{{ route('comment.destroy', $comment->id) }}" method="post">
                                            ...
                                            {{-- If the AUTH user is the owner of the comment, then display the delete buttons --}}
